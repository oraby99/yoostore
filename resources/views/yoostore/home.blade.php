    ...
    >
      <div class="bg-danger w-25 mx-4">
        <div class="banner2 p-5">
          ...
          <span style="font-size: 13px">Offers ends in</span
          ><span
            style="background-color: white; font-size: 13px; font-weight: 600; p-1"
      ...
      <div class="products w-75 p-3">
        <div class="d-flex justify-content-between">
          <span style="font-size: 22px; font-weight: 600"
            >Featuerd Products</span
          >
          <div class="featuerd">
            <span class="featureitem">All Products</span>
            <span class="featureitem">Smart phone</span>
            <span class="featureitem">Laptop</span>
            <span class="featureitem">Headphone</span>
            <span class="featureitem">TV</span>
    ...
    >
          ...
          <div class="w-100 row col-12">
            <div class="col-4">
              <div class="card custom-card">
                ...
                >
                <img
                  src="{{ asset('yoostore/images/banner 2.jpeg')}}"
                  class="card-img-top"
                  alt="Smartphone"
                />
                <div class="card-body">
      ...
      <div class="w-25 mx-4">
        <div class="banner2 p-5" style="background-color: #124261">
          ...
          <span style="font-size: 13px" class="text-white text-center"
            >OFFERS ENDS IN OF CHRISTMAS</span
          >
          <button>shop now <i class="fa-solid fa-arrow-right mx-3"></i></button>
        </div>
        <div>
