...
class ProductResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'avg_rate' => $this->getAvgRateAttribute(), // Add the average rating
            ...
            'childproduct' => $this->whenLoaded('childproduct', function () {
                return $this->childproduct->map(function ($child) {
                    return new ChildProductResource($child, $this->userId); 
                });
            }),
